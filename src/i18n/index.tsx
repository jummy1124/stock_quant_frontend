...
const zhTW: Dict = {
  ...
  "bt.allHistory": "全部歷史",
  "bt.horizonsHint": "點按鈕選要統計的交易日數（可複選，至少一個）。其他天數用右邊的輸入欄加進來，加完一樣會變成按鈕，可再點掉。",
  "bt.horizonsHint.intraday": "點按鈕選要統計的交易日數（可複選，至少一個）。其他天數用右邊的輸入欄加進來 —— 填 0 表示「13:00 買進、當日收盤結算」。",
  "bt.customN.label": "其他天數",
  "bt.customN.placeholder": "例 3",
  "bt.customN.add": "加入",
  "bt.customN.integer": "請輸入整數天數。",
  "bt.customN.range": "天數需介於 0 ～ {max}。",
  "bt.customN.zeroOnlyIntraday": "N=0 等於自己跟自己比，只有「盤中 13:00 → 收盤價」模式適用。",
  "bt.customN.tooMany": "一次最多統計 {max} 個天數，請先點掉一個。",
  "bt.run": "開始回測",
...
const en: Dict = {
  ...
  "bt.run": "Run backtest",
  "bt.horizonsHint": "Click to pick the holding periods to measure (at least one). Add any other number with the field on the right — it becomes a button too, and can be clicked off again.",
  "bt.horizonsHint.intraday": "Click to pick the holding periods to measure (at least one). Add any other number with the field on the right — enter 0 for \"bought at 13:00, marked at that day's close\".",
  "bt.customN.label": "Other",
  "bt.customN.placeholder": "e.g. 3",
  "bt.customN.add": "Add",
  "bt.customN.integer": "Enter a whole number of trading days.",
  "bt.customN.range": "Must be between 0 and {max}.",
  "bt.customN.zeroOnlyIntraday": "N=0 would compare a price with itself; it only applies to the 13:00-to-close mode.",
  "bt.customN.tooMany": "At most {max} holding periods at once — remove one first.",
